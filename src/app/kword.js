export let data = [
    ...
    },
    {
      ...
      consume:'v.消耗；吃，喝',
      spend:'v.花费；n.开支',
      cost:'v.需付费；n.费用；代价；成本',
      expense:'n.费用，花费',
      revenue:'n.(公司，组织的)收入；（政府的）税收，财政收入',
      gross:'adj.总的，毛的',
      recession:'n.经济衰退',
      ...
      deflation:'n.通货紧缩',
      dwindle:'v.缩小，减少',
      decrease:'n.减少，减小；v.使减少，使减小',
      downsize:'v.使精简；裁员',
      decline:'v./n.下降',
      diminish:'v.使减少；贬低',
      reduce:'v.减少，减小',
      increase:'n.增加，增长；v.使增加，使增长',
      increment:'n.增加量；定期的加薪',
      growth:'n.增长；生长',
      escalate:'v.使逐步升级，使不断恶化',
      expand:'v.扩充，扩大；扩展',
      influx:'n.流入，涌进',
      ...
      turnover:'n.(人员)流动率；营业额',
      dump:'v.丢弃，倾倒；倾销',
      export:'v.出口；n.出口；出口商品',
      import:'v.进口；v.进口；进口商品',
      quota:'n.限额，配额；定额',
      share:'n.股份，股票；一份；v.分享；共享；分担',
      benefit:'n.益处；v.有利于；获益',
      ...
      resume:'n.(求职用的)履历，简历；摘要',
      recommend:'v.推荐，介绍；劝告，建议',
      employ:'v.雇用;采用',
      hire:'v.雇用；租用；n.租赁（业）',
      fire:'v.解雇；n.火',
      lay_off:'n.(因岗位不足的)解雇，裁员；歇工期',
      dismiss:'v.解雇；解散；（法官）驳回',
      discharge:'v.解雇；n.(船的)卸货',
      resign:'v.辞去，辞职',
      sack:'n.大口袋，麻布袋；v.开除',
      retire:'v.使退休',
      result:'n.后果，结果；v.导致',
      failure:'n.失败；失败的人；失败的事',
      abortion:'n.人工流产；（计划等）中途失败',
      loss:'n.遗失；损失；亏损',
      opportunity:'n.机会，时机',
      chance:'n.机会；可能性',
      choose:'v.选择',
    ...
    },
    {
      ...
      whisper:'v.低声说；私下讨论',
      mutter:'v.轻声低语；小声抱怨',
      murmur:'v.低声说；n.咕哝，低语',
      silent:'adj.沉默的；寂静无声的',
      mute:'adj.缄默的；哑的；无声的；n.哑巴',
      investigate:'v.调查',
      ...
      penalty:'n.惩罚，处罚',
      fine:'n.罚款；adj.美好的',
      mortgage:'v.抵押（房屋，土地）借款；n.房屋抵押贷款',
    ...
    },
    {
      ...
      battle:'n.战斗，战役；v.与......战斗',
      struggle:'v./n.挣扎；奋力；奋斗',
      explosion:'n.爆发；迸发；爆炸；激增',
      bombard:'v.轰击，轰炸；连珠炮般质问（或批评）',
      bomb:'n.炸弹；v.轰炸',
      blast:'n.爆炸；v.爆炸，炸毁',
      burst:'v.使爆裂；使胀开；n.迸发；爆裂',
      spark:'n.火花，火星',
      twinkle:'n./v.闪烁，闪耀',
      gunpowder:'n.火药',
      tank:'n.坦克；罐，槽，缸',
      cannon:'n.大炮，加农炮；（飞机上的）自动机关炮',
      missile:'n.导弹；投掷物',
      weapon:'n.武器，兵器；手段',
      pistol:'n.手枪',
      rifle:'n.步枪',
      bullet:'n.子弹，枪弹',
      target:'n.靶子；目标，对象',
      deflect:'v.使偏斜，使偏转；转移',
      mission:'n.使命；重要任务',
      flame:'n.火焰;强烈的感情',
      flare:'n.(闪耀的)火光；闪光信号灯；v.（火光）闪耀',
      ...
      beat:'v.打，打败；（心脏等）跳动；n.节拍；击鼓声；（心脏的）跳动',
      ...
      pause:'n./v.暂停，停顿',
      halt:'v.使停止，使停住；n.停止，停住',
      cease:'v.终止，停止',
      oppose:'v.反对，抵制',
      oppress:'v.压迫，压制；使压抑',
      counter:'v.抵消；反击，反驳；adv.相反地；n.柜台；工作台',
      deter:'v.阻止，威慑住',
      forbid:'v.禁止；阻止',
      prohibit:'v.禁止，不允许',
      prevent:'v.预防，防止；阻止，阻碍',
      revolt:'n./v.叛乱；反抗',
      betray:'v.背叛，出卖；（无意中）泄漏，流露出',
      treason:'n.叛国罪，通敌罪',
      rebel:'n.反判者；叛逆者；v.造反；反抗，反对',
      traitor:'n.叛徒，卖国贼',
      patriot:'n.爱国者',
      blame:'v.责备，指责；n.（对坏事应付的）责任',
      reproach:'n./v.责备，指责',
      evidence:'n.证据；根据',
      proof:'n.证明，证据',
      terror:'n.恐惧，恐慌',
      terrible:'adj.可怕的，糟糕的；极严重的',
      terrific:'adj.极大的；很大的，很强的',
      horrible:'adj.可怕的，恐怖的',
      alarm:'n.惊恐，忧虑；警报；警报器',
      dread:'v.极为害怕的，非常担心；n.恐惧，忧虑',
      frighten:'v.使害怕，使惊恐',
      tension:'n.紧张；拉近状态',
      ...
      refute:'v.反驳，驳斥；否认',
      might:'n.力量，威力',
      force:'n.力量；武力；v.强迫，迫使；用力使......移动',
      reinforce:'v.增援；增强，加强；加固',
      impair:'v.削弱；妨碍',
      mitigate:'v.减轻，缓和',
      comfort:'n.安慰；舒适；v.安慰，抚慰',
      event:'n.事件，大事；公开活动',
      matter:'n.事件；物质；v.要紧',
      happen:'v.发生，出现；碰巧',
      occur:'v.发生，出现',
      savage:'adj.野蛮的，凶猛的；v.凶猛地攻击；n.野蛮人',
      reckless:'adj.鲁莽的，不计后果的',
      fierce:'n.凶猛的；猛烈的；（天气或温度的）恶劣的',
      foul:'adj.恶臭的；恶劣的；邪恶的；v.弄脏；对......犯规',
      evil:'n.邪恶；祸害；adj.邪恶的',
      devil:'n.魔鬼；恶棍',
      punishment:'n.惩罚，处罚',
      execute:'v.实行，执行；处死',
      hang:'n.悬挂；悬浮（在空中）；（被）绞死',
      sacrifice:'n.牺牲；献祭；v.牺牲；以......为祭品',
      casualty:'n.伤亡人员',
      bury:'v.埋葬；埋藏',
      funeral:'n.葬礼',
      ...
      landing:'n.着陆；登陆',
      hover:'v.盘旋，悬浮；徘徊；处于不稳定状态',
      proceed:'v.接下来做；继续前行；行进',
      ...
      conquer:'v.征服；克服，战胜',
      monument:'n.纪念碑；历史遗迹；典范',
      tablet:'n.碑，匾；药片',
      statue:'n.雕像，塑像',
      medal:'n.勋章，奖章',
      honour:'n.尊敬，敬意；荣誉；v.尊敬；给予表扬',
      glorious:'adj.光荣的，荣耀的',
      contribute:'v.捐献；（为......）作贡献；（为书，报刊等）撰稿',
      devote:'v.献身；投入',
    ...
    },
    {
      ...
      spouse:'n.配偶（指夫或妻）',
      husband:'n.丈夫',
      gay:'n.同性恋者（尤指男性）；adj.同性恋的；快乐的；艳丽的',
      grandfather:'n.(外)祖父',
      father_in_law:'n.岳父；公公',
      sibling:'n.兄；弟；姐；妹',
      cousin:'n.堂（或表）兄（弟姐妹）',
      nephew:'n.侄子；外甥',
      niece:'n.侄女；外甥女',
      twin:'adj.成双的；n.双胞胎之一',
      embryo:'n.胚胎；adj.胚胎的；初期的',
      infant:'n.婴儿；adj.供婴儿用的；婴儿的',
      orphan:'n.孤儿；v.使成为孤儿',
      juvenile:'adj.少年的；n.少年',
      youngster:'n.年轻人；少年',
      youth:'n.青年时期；青春；（统称）青年',
      gang:'n.一帮，一伙（常聚在一起打架闹事的年轻人）',
      teenager:'n.(13到19岁之间的)青少年',
      adolescence:'n.青春期',
      kin:'n.(统称)家属，亲戚;adj.有血缘关系的；类似的',
      folk:'n.人们；家属，亲属',
      ...
      honeymoon:'n.蜜月',
      kiss:'v.吻，接吻；n.吻',
      divorce:'n.离婚；脱离；v.（与......）离婚；使脱离',
      separate:'adj.公开的，单独的；v.使分开；分局',
      single:'adj.单一的；单身的',
      sole:'adj.仅有的，唯一的',
      respective:'adj.各自的，分别的',
      each:'pron.各自，各个；det.各，每',
      individual:'n.个人；个体；adj.个别的，单独的',
      commuter:'n.上下班往返者，通勤者',
      neighbourhood:'n.街坊；居住区；周边地区',
      member:'n.成员；会员',
    ...
    },
    {
      ...
      overtake:'v.追上，超过；（情感等）压到',
      follow:'v.跟随；是......的必然结果；遵循',
      grip:'v.紧握，抓牢；n.紧握，抓牢；理解，了解',
      mess:'n.混乱，脏乱；v.弄乱',
      twist:'v.拧，扭；使缠绕；n.拧，扭动',
      scatter:'v.撒；使散开',
      fold:'v.折叠，对折',
      fasten:'v.扣牢，系牢，缚紧',
      loosen:'v.解开，松开；放宽（限制等）',
      smash:'v.打碎；使猛烈撞击；（打球时）扣球',
      scratch:'v.擦破，刮坏；搔；n.乱涂；划痕，擦伤',
      wipe:'v.擦',
      scrape:'v.刮掉；擦坏；勉强获得；n.刮；擦伤',
      polish:'v.擦光，擦亮；使完美，改进',
      peel:'v.剥落；掉漆；脱皮',
      split:'v.使开裂；使分裂；使分开',
      sway:'v.使摇摆，使摆动，使摇晃',
      shake:'v.摇动，使颤动；n.摇动，颤动',
      vibrate:'v.使振动，使摇摆',
      whirl:'v.使回旋；n.回旋',
      rotate:'v.使旋转，使转动',
      reel:'v.眩晕，混乱',
      shuffle:'v.洗（牌）；拖着脚走；搅乱......的次序；n.洗牌',
      collide:'v.碰撞；抵触',
      contact:'n./v.接触，联系',
      connect:'v.使连接；使接通（电源）',
      combine:'v.使联合，使结合',
      bond:'v.与......黏合（或连接）；n.黏合；（感情的）纽带',
      integrate:'v.使成为一体，使合并',
      wrap:'v.裹，包；用......缠绕',
      ...
      tilt:'v.使倾斜，使歪斜',
      tow:'v.拖，拉，牵引；n.牵引',
      trail:'v.使拖在后面；跟踪；n.踪迹',
      arrange:'v.安排，整理，使有条理',
      manipulate:'v.(熟练地)操作；操纵',
      steer:'v.为（船）操舵，驾驶（船，车等）；操纵',
      baptise:'v.给......施行洗礼',
      ...
      expel:'v.驱逐；开除；排出',
      flee:'v.逃避，逃离',
      bully:'v.恐吓，欺凌；n.持强凛弱者',
      panic:'n.惊恐，惊慌；v.使惊恐，使惊慌',
      terrify:'v.使恐惧，使非常害怕',
      revenge:'n.报仇，复仇；v.向......报仇',
      kidnap:'v.绑架，劫持',
      ...
      detach:'v.使分开，使分离；派遣',
      undo:'v.解开，打开；取消',
      disguise:'v.掩饰；假扮，伪装；n.假扮；伪装物',
      conceal:'v.隐藏，掩盖',
      refuse:'v.拒绝；回绝',
      exclude:'v.把......排除在外；拒绝',
      reverse:'v.颠倒，彻底改变；撤销；n.相反的情况；反面；adj.相反的',
      assure:'v.向......保证；保证；保险',
      ...
      range:'v.(在一定幅度内)变动',
      sort:'n.种类，类别；v.把......分类',
      loom:'v.(庞然大物或形状模糊之物)隐现；逼近；n.织布机',
      launch:'v.发射；发布，推出；发起（运动等）',
      commence:'v.开始，着手',
      exploit:'v.开发，开采，开拓',
      explore:'v.勘查，考察；探讨',
      exert:'v.运用，行使；施加',
      ...
      resort:'v.求助于，采取，诉诸；n.(度假)胜地',
      recover:'v.重新拿回，恢复健康；（从不愉快的经历中）复原',
      restore:'v.恢复；归还；修复',
      rectify:'v.纠正，矫正，改正',
      ...
      supply:'v.供给，供应，提供；n.供应量；补给品',
      offer:'n.给予（物）；提议；v.提供；出（价）',
      render:'v.给予，提供；翻译',
      enlarge:'v.扩大，扩展；放大（照片或文件）',
      augment:'v.扩大，增加，加强，提高',
      magnify:'v.放大；夸大',
      amplify:'v.增强；扩大（声音）；充实（陈述等）',
      exaggerate:'v.夸大，夸张',
      prolong:'v.延长',
      uphold:'v.支持，维护；维持',
      backup:'n.后援，支持；（文件等的）备份；adj.备用的',
      propel:'v.推动，驱使；推进',
      update:'v.更新；使现代化',
      ...
      regard:'n.尊重；问候；v.看待',
      flatter:'v.奉承，讨好，向......掐媚',
      worship:'n.(对上帝或神的)崇拜，礼拜；爱慕；v.做礼拜',
      cause:'n.原因，理由；事业；v.引起，导致',
      sake:'n.理由，目的',
      purpose:'n.目的',
      objective:'n.宗旨；目标；adj.客观的',
      arouse:'v.唤起，激起，引起',
      trigger:'v.引发，触发；n.（枪等的）扳机',
      seek:'v.寻找；寻求',
      retrieve:'v.取回；挽回',
      testify:'v.作证；证明',
      verify:'v.证实；核实，查清',
      ...
      impart:'v.传授；透露',
      deserve:'v.应得；应受',
      drop:'v.使落下；使降低；和......断绝联系；n.滴',
      sink:'v.使下沉；下降',
      plummet:'v.垂直掉下；（价格，水平）骤然下降',
      muffle:'v.使(声音)减轻',
      overshadow:'v.遮蔽；使黯然失色',
      invite:'v.邀请',
      welcome:'n./v.欢迎',
      greet:'v.向......问好，迎接；对......做出反应',
      salute:'v.向......行礼；致敬；n.行礼，致敬',
      ...
      pervade:'v.弥漫，渗透，遍及',
      replace:'v.代替，取代',
      substitute:'v.替换；n.代用品；代替者；替补（运动员）',
      distinguish:'v.区别，辨别；使出众，使著名',
      differentiate:'v.区分，区别；差别对待',
      incline:'v.使倾向于；使倾斜；n.斜坡；倾斜',
      lean:'v.使倚靠；倾斜；adj.瘦的；贫乏的',
    ...
    },
    {
      ...
      lung:'n.肺',
      gland:'n.腺',
      chamber:'n.(人体内，动植物体内或机械内的)室，腔；议院',
      intestine:'n.肠',
      thigh:'n.大腿，股',
      joint:'n.接合处；关节；adj.共同的，联合的',
      knee:'n.膝盖，膝',
      lap:'n.(人坐着时的)大腿部；下摆；环节；一圈',
      ankle:'n.踝关节，踝',
      heel:'n.足跟',
      toe:'n.脚趾，足尖',
      muscle:'n.肌肉',
      ...
      lame:'adj.瘸的，跛的；（解释或借口）无说服力的',
      dwarf:'n.(童话中的)小矮人；侏儒；adj.矮小的',
      pregnancy:'n.怀孕',
      born:'adj.天生的；与生俱来的；v.出生',
      condom:'n.避孕套',
      clone:'v.克隆；n.克隆（动植物）',
      symptom:'n.征兆；症状',
      disease:'n.疾病',
      ...
      dizzy:'adj.头晕目眩的，眩晕的；v.使眩晕',
      insane:'adj.患精神病的；疯狂的',
      insomnia:'n.失眠，失眠症',
      allergy:'n.敏感症；过敏症',
      heart_attack:'n.心脏病发作',
      cancer:'n.癌',
      arthritis:'n.关节炎',
      pimple:'n.粉刺，丘疹',
      stroke:'n.中风；击打；一笔（画）',
      plague:'n.瘟疫',
      flu:'n.流行性感冒',
      fever:'n.狂热；发烧，发热；v.使发烧；使狂热',
      headache:'n.头痛',
      swell:'v.肿胀，膨胀；使增加',
      choke:'v.使窒息；阻塞；说不出话',
      injure:'n.伤害；损害',
      hurt:'v.损害；伤害；使疼痛',
      bleed:'v.流血；榨取；给......放血；放掉（气体或水）',
      bruise:'n.淤伤；伤痕；v.擦伤',
      scar:'n.疤痕，伤疤',
      wound:'n.创伤，伤害；伤口',
      ...
      demise:'n.死亡；君权的转移或授予，禅让；v.遗赠，转让',
      doom:'n.厄运；毁灭；v.使注定失败',
      fatal:'adj.致命的；毁灭性的；决定性的',
      lethal:'adj.致命的',
      corpus:'n.尸体；文集；本金',
      overwork:'n.过度操劳；过度工作；v.使过度工作',
      tire:'v.使感到疲劳；厌烦',
      ...
      pill:'n.药丸，丸剂',
      antibiotic:'n.抗生素',
      acupuncture:'n.针灸，中医针灸法',
      penicillin:'n.青霉素',
      morphine:'n.吗啡',
      dose:'n.(药物的)一剂；v.给......喝药',
      recovery:'n.恢复，痊愈',
      refresh:'v.使恢复精神',
      relief:'n.宽慰，轻松，减轻，缓解',
      relieve:'v.救济；减轻，解除（痛苦）',
      alleviate:'v.减轻（痛苦等），缓解',
      ...
      intuition:'n.直觉',
      spontaneous:'adj.自发的，自然的，本能的；自然产生',
      implicit:'adj.暗示的，含蓄的；不怀疑的，无保留的',
      illusion:'n.错觉；幻想',
      imaginary:'adj.想象的，虚构的',
      fancy:'n.想象（力）；爱好；v.认为，想象',
      fate:'n.命运，宿命',
      fortune:'n.命运；运气；财产',
      agony:'n.极度的痛苦；挣扎',
      grief:'n.极度悲伤',
      ...
      suspicion:'n.怀疑，嫌疑',
      sceptical:'adj.怀疑的',
      unsatisfactory:'adj.不能令人满意的，不符合要求的',
