export let data= [
    {
        ...
        english:"Sound receptors are small devices that are floppy and spiky in the ears.These receptors can translate vibrational energy that hits your eardrum into a vibration of the fluid in your ears.Then the physical motion of these receptors will be translated into electrical signals that go into your ear.MIT students are invited to learn more about sound receptors, who would find sound receptors remarkable.",
        array:[
            {
    ...
    },
    {
        ...
        title:'Tree Rings',
        titleDescription:'年轮',
        english:"Dendrochronologists study hidden information in tree rings that indicate the climate, just like a Morse code but with richer content.The width of tree rings indicates the rain and drought, so scientists cut down trees and count the tree rings inward to collect information.The study of tree rings can help scientists to reconstruct the climate.",
        array:[
            {
    ...
    },
    {
        ...
        english:"Now more people have realized that the global economic and financial crisis also concerns common ethical values and standards.The speaker is concerned that the global economy has become unethical and unfair as the emergence of global capitalism has brought new risks.Core ethical values and standards are universal although they are culture-bound.The speaker believes that the global market economy must be socially acceptable before being accepted in different regions.",
        array:[
            {
    ...
    },
    {
        ...
        english:'The nature of the business entity is to exchange something you have for something you desire.The function of marketing is to transfer products from suppliers to consumers to meet their demands.Meanwhile,the capital gain is crucial, and it is important to assure capital return because that is how investment and production can continue.',
        array:[
            {
    ...
    },
    {
        ...
        english:"Humans used to tell a computer what to do and how to do it.When given the meaning of certain words, computers can operate as programmed and develop systems and symbols.In other words,computers turn messages into bytes.Therefore, computers may have the potential to bring artificial intelligence.",
        array:[
            {
    ...
    },
    {
        ...
        titleDescription:'定义风险',
        english:"The lecture on risk analysis focuses on the definition of risk and safety.There are two literal definitions of ‘risk’ in dictionaries.One means the possibility of loss or injury while the other means the consequences of some kinds of danger.Moreover, the definition of ‘safe’ or ‘safety’ means being free from harm, which is a simple notion of being either safe or not safe.",
        array:[
            {
